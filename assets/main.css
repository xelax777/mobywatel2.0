...
:root{
    --home: url('https://i.imgur.com/2dhn83I.png');
    --home-open: url('https://i.imgur.com/snRZd8Y.png');
    --documents: url('https://i.imgur.com/lZtlC1m.png');
    --documents-open: url('https://i.imgur.com/IsGxaKU.png');
    --services: url('https://i.imgur.com/7isZVH1.png');
    --services-open: url('https://i.imgur.com/VfJjlqg.png');
    --qr: url('https://i.imgur.com/ZWhsWUD.png');
    --qr-open: url('https://i.imgur.com/IN7owEB.png');
    --more: url('https://i.imgur.com/1Bg8T7m.png');
    --more-open: url('https://i.imgur.com/ESjnL7k.png');
    --text: #024b97;
